...
**Handoff a: Trazo (IT).** La Talaia especifica què necessita l'arnès generatiu; la decisió i el cablatge d'infra són de la Trazo. Preus i IDs verificats contra la documentació de l'API el 2026-07-02. El repo és **públic**: cap secret hi pot entrar mai.
...
|---|---|---|---|
| Generador | `claude-sonnet-4-6` | $3 / $15 | El nivell realista d'un «Pregunta-li» de producció: fort, actual, no premium. Mesurar el cost de la fluïdesa sobre un model que de debò faríem servir. Mostreig per defecte (estocàstic; N=5 el captura). |
...
- **Passada oficial:** 34 Q × 5 passades = **170 crides de generació** (~2–3,5k tokens d'entrada per crida: prompt congelat + pregunta + context recuperat; ~300–500 de sortida) + **170 crides de validació** (~2k in / ~150 out). ≈ 0,5–0,8 M tokens d'entrada + ~0,1 M de sortida en total → **~3–5 $** la passada oficial.
